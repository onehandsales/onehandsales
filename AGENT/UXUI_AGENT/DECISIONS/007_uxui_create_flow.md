...
2026-07-10 기준 회사 생성은 오른쪽 문서형 생성 패널로 전환한다. 담당자/제품/딜은 기존 동작을 유지하되, 후속 UX/UI 통일 작업에서는 회사 생성 패널 기준을 우선 검토한다.
...
반대로 딜 상세, 회사 히스토리, 제품 연결, Memo 기록 같은 복잡한 정보는 작은 모달에서 다루기 어렵다.
