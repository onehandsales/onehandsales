...
로그인 이후 첫 화면은 `/app` 홈이다. 핵심 지표, 진행 중인 딜, 마감 임박 다음 행동, 최근 활동이 한눈에 보여야 한다.
...
- 상세는 속성, 연결 record, 메모, 활동을 구분한다.
- 딜 상세는 단계, 금액, 연결 제품, 다음 행동을 가장 먼저 보여준다.
- 메모와 활동 로그는 시간순 흐름이 끊기지 않게 표시한다.
