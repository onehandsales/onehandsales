...
6. `PM_AGENT/PLANNING/DATA_MODEL.md`
7. `UXUI_AGENT/PLANNING/USER_FLOW_AND_SCREENS.md`
8. `UXUI_AGENT/PLANNING/UX_UI_DIRECTION.md`
9. `SOFTWARE_AGENT/BACKEND_AGENT/ARCHITECTURE/OVERVIEW.md`
10. `SOFTWARE_AGENT/BACKEND_AGENT/ARCHITECTURE/BACKEND.md`
11. `SOFTWARE_AGENT/BACKEND_AGENT/CONVENTION/BACKEND.md`
12. `SOFTWARE_AGENT/BACKEND_AGENT/CONVENTION/API_SPEC.md`
13. `SOFTWARE_AGENT/BACKEND_AGENT/CONVENTION/API_CONTRACT.md`
14. `SOFTWARE_AGENT/BACKEND_AGENT/CONVENTION/TRANSACTION.md`
15. `SOFTWARE_AGENT/BACKEND_AGENT/CONVENTION/OBSERVABILITY.md`
16. `SOFTWARE_AGENT/BACKEND_AGENT/CONVENTION/COMMENT_AND_LOGGING.md`
17. `SOFTWARE_AGENT/FRONT_AGENT/ARCHITECTURE/FRONTEND_USER_WEB.md`
18. `SOFTWARE_AGENT/FRONT_AGENT/ARCHITECTURE/ADMIN_WEB.md`
19. `SOFTWARE_AGENT/FRONT_AGENT/CONVENTION/FRONTEND_USER_WEB.md`
20. `SOFTWARE_AGENT/FRONT_AGENT/CONVENTION/ADMIN_WEB.md`
21. `SOFTWARE_AGENT/DB_SCHEMA/README.md`
22. `PM_AGENT/CONVENTION/DOCUMENTATION.md`
23. `PM_AGENT/CONVENTION/PLANNING_REVIEW_CHECKLIST.md`
