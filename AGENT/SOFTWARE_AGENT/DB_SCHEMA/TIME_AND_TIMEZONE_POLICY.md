...
- 신규 사용자는 exchange metadata로 `preferredLocale`, `timeZone`, `countryCode`, `defaultCurrencyCode`, `signupLocale`, `signupTimeZone`, `lastLoginLocale`, `lastLoginTimeZone`을 초기화한다.
