...
- `TODO/{PLAN_NAME}/BE-TODO/API-SPEC.md`
...
3. 같은 userId 안에서 회사명 중복 후보를 확인한다.
4. Company entity를 생성한다.
5. PrismaCompanyRepository로 저장한다.
6. 저장된 Company를 CompanyResponse로 변환한다.
```
...
- 조회: User
- 감사 로그: 없음
- transaction: 단일 Company insert라 필수 아님
```
