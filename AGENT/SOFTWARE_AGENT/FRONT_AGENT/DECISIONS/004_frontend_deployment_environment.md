...
- production 배포 전에는 User Web 전체 E2E와 Admin auth/role 수동 smoke를 다시 실행한다. Admin auth smoke E2E는 현재 router 기준으로 갱신한 뒤 추가하고, Admin 전체 E2E는 Admin 페이지와 Backend 운영 조회 API 구현 후 추가한다.
