...
2026-08-11 기준 Global B2C 01~11 Frontend foundation은 완료 archive다. 남은 출시 전 Web Front QA는 기존 기능 유지보수, UX/UI 공통 QA, 모바일 브라우저 QA, Chrome/Edge 브라우저 QA, 결제창 없는 100명 베타 준비다.
