...
`AGENT/SOFTWARE_AGENT`의 직접 하위 구조는 다음 세 폴더를 기준으로 둔다.
...
- Backend, User Web, Admin Web에 함께 영향을 주는 인증/세션 결정은 PM 결정 문서에 최종 기록하고, `BACKEND_AGENT`, `FRONT_AGENT`, `DB_SCHEMA`에 필요한 내용을 각각 반영한다.
