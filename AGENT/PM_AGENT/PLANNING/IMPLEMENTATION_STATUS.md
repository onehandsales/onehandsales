...
- Backend: Auth/User, Company, Search, Trash, Error Report, Support Request, Public Contact Request, Health, `GET /admin/api/me`
- Frontend User Web: `/app` 홈, 회사, 검색, 휴지통, 더보기/계정 모달, 도움말 접수, 공개 문의
