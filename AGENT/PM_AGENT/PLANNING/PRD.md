...
> 현재 구현 스냅샷: 2026-07-03 `BE`, `FE/user-web`, `FE/admin-web`
...
- 구현 완료: DataImport는 회사/담당자/제품/딜 양식 다운로드, CSV/XLSX 업로드, AI 컬럼 매핑, 사용자 보정/검증, 확정 저장, 성공 내역 조회를 제공한다. 확정 전 job은 in-memory store를 사용한다.
