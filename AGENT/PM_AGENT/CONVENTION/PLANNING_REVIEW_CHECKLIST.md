...
11. 문서 간 충돌, 누락, 애매한 표현, 구현 불가능한 요구를 발견한다.
12. 발견 사항을 심각도별로 정리하고, 수정이 가능한 것은 문서에 반영한다.
13. 사용자의 판단이 필요한 사항은 질문 또는 결정 필요 항목으로 남긴다.
...
- Backend 기준: `AGENT/SOFTWARE_AGENT/ARCHITECTURE/OVERVIEW.md`, `AGENT/SOFTWARE_AGENT/ARCHITECTURE/BACKEND.md`, `AGENT/SOFTWARE_AGENT/CONVENTION/BACKEND.md`, `AGENT/SOFTWARE_AGENT/CONVENTION/API_SPEC.md`
- User Web 기준: `AGENT/SOFTWARE_AGENT/ARCHITECTURE/FRONTEND_USER_WEB.md`, `AGENT/SOFTWARE_AGENT/CONVENTION/FRONTEND_USER_WEB.md`
- Admin Web 기준: `AGENT/SOFTWARE_AGENT/ARCHITECTURE/ADMIN_WEB.md`, `AGENT/SOFTWARE_AGENT/CONVENTION/ADMIN_WEB.md`
...
- 테스트/위험 흐름 기준: `AGENT/SOFTWARE_AGENT/ARCHITECTURE/TESTING.md`, `AGENT/SOFTWARE_AGENT/ENGINEERING_REVIEW_CHECKLIST.md`
