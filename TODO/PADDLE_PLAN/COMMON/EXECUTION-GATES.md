...
- 1차 후보: 한국/KRW 유료 검증
- 2차 후보: 미국/USD 유료 검증
- 3차 후보: 캐나다/CAD 또는 USD 유료 검증. CAD 지원 여부는 가격/세금/정산 정책 gate에서 확정한다.
- 보류 후보: 일본/대만/영국/싱가포르/호주 확장

이 순서는 2026-08-24 KR/US/CA 우선 시장 결정을 반영한 후보이다. 실제 Paddle product/price/currency 설정은 베타 피드백과 가격 결정 후 확정한다.
