...
사용자는 앱을 열자마자 진행 중인 딜을 확인하고, 회사/거래처(담당자)/제품을 빠르게 등록하며, 딜/일정/회의록을 연결해 영업 흐름을 관리할 수 있어야 한다.
...
| `/contacts` | 거래처(담당자) 목록 | 1 |
| `/contacts/:contactId` | 거래처 상세 | 1 |
| `/products` | 제품 목록 | 1 |
...
- 거래처는 회사 아래 사람이라는 구조가 UI에서 명확하다.
...
- 한 키워드로 회사, 거래처, 제품, 딜, 일정, 회의록을 찾을 수 있다.

## 15. 휴지통 Feature

### 작업 목록

- 삭제된 회사/거래처/제품/딜/일정/회의록 목록
- 대상 유형 필터
- 복구
- 완전 삭제 예정일 표시
- 7일 전 알림 상태 표시
