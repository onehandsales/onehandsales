...
2026-08-31 기준 `G01-ACTIVE-SERVICE-QA-API-SPEC-NORMALIZATION.goal.md`, `G02-DONE-API-SPEC-AUDIT-INDEX.goal.md`, `G03-DONE-CORE-USER-API-SPEC-NORMALIZATION.goal.md`, `G04-DONE-MOBILE-FIELD-API-SPEC-NORMALIZATION.goal.md`, `G05-DONE-ADMIN-OPERATION-API-SPEC-NORMALIZATION.goal.md`를 완료했다.
...
- `G06-DONE-DOMAIN-GLOBAL-DATA-API-SPEC-NORMALIZATION.goal.md`: Domain Global Data 복합 API-SPEC 정규화, 다음 실행 대상
