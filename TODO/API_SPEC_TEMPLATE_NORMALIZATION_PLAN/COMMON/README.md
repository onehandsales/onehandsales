...
상태: In Progress / G03 Completed / G04 Next

## 1. 목적

이 폴더는 API-SPEC 템플릿 정규화 계획의 공통 감사 결과와 실행 순서를 관리한다.

2026-08-31 기준 `G01-ACTIVE-SERVICE-QA-API-SPEC-NORMALIZATION.goal.md`, `G02-DONE-API-SPEC-AUDIT-INDEX.goal.md`, `G03-DONE-CORE-USER-API-SPEC-NORMALIZATION.goal.md`를 완료했다.

다음 실행 대상은 `G04-DONE-MOBILE-FIELD-API-SPEC-NORMALIZATION.goal.md`이다.
...
- `G04-DONE-MOBILE-FIELD-API-SPEC-NORMALIZATION.goal.md`: 보관 Mobile Field API-SPEC 정규화, 다음 실행 대상
