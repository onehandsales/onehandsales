...
| 순서 | Goal | 담당 | 상태 | 선행 조건 |
|---:|---|---|---|---|
| 1 | `G01-BE-MEETING-NOTE-DOMAIN` | Backend | ready | Auth/User, Company, Contact, Product, Deal, User.timeZone 구현 완료 |
| 2 | `G02-FE-MEETING-NOTE-PAGES` | Frontend | ready | G01 완료 |
| 3 | `G03-MEETING-NOTE-INTEGRATION` | Common | ready | G01, G02 완료 |
...
- `TODO/MEETING_NOTE_MANUAL_PLAN/BE-TODO/G01-BE-MEETING-NOTE-DOMAIN.goal.md`
...
- `TODO/MEETING_NOTE_MANUAL_PLAN/FE-TODO/G02-FE-MEETING-NOTE-PAGES.goal.md`
...
- `TODO/MEETING_NOTE_MANUAL_PLAN/COMMON/G03-MEETING-NOTE-INTEGRATION.goal.md`
