...
TODO/
  ...
  DONE/
    README.md
    BE_SOFTWARE_AGENT_RULE_RECHECK_FIX_PLAN.md
...
- 현재 즉시 실행 가능한 API-SPEC 정규화 goal은 없다. QA에서 발견된 S0/S1/S2 결함이나 새 요구사항은 `TODO` 바로 아래에 새 계획 폴더를 만들거나, `TODO/SERVICE_QA_PLAN`의 이슈 로그에서 후속 구현 계획으로 승격한다.
...
- `BE_SOFTWARE_AGENT_RULE_RECHECK_FIX_PLAN.md` 단일 완료 포인터 문서도 `TODO/DONE/BE_SOFTWARE_AGENT_RULE_RECHECK_FIX_PLAN.md`에 보관한다.
...
- `API_SPEC_TEMPLATE_NORMALIZATION_PLAN`: `TODO/DONE/API_SPEC_TEMPLATE_NORMALIZATION_PLAN`
