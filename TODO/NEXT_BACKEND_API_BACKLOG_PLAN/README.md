...
상태: Draft
작성일: 2026-07-20
출처: `TODO/USER_WEB_RELEASE_QA_FOLLOWUP_PLAN` G07
...
- latest activity/next action summary, MeetingNote summary, ImportJob persistence, Schedule week report, Notification은 product feature 후보다.
...
- Notification, ImportJob persistence, Admin API 구현
