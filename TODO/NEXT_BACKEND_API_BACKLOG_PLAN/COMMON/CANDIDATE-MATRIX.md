...
- [x] `08_GLOBAL_DATA_I18N`: Done (2026-07-28)
  ...
  - 현재 의미: first-sale global data/i18n/API subset은 완료다. DB migration은 최신 상태 확인 완료, 실제 Google/LINE/Apple provider smoke는 운영 확인 단계에서 본다.
...
4. 실제 auth provider smoke, backup/restore, 장애 대응은 Global B2C data reliability/operation gate에서 별도 결정
