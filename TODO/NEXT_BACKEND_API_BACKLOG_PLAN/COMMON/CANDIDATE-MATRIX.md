...
완료 이력으로 승격된 `NBA-001`, `NBA-002`, `NBA-003` Deal subset, `NBA-006`, `NBA-008`, `NBA-009`, `NBA-010`, `NBA-014`, `NBA-015` 외의 후보 API 계약은 `draft` 또는 `후보` 상태로만 남긴다.
...
1. `NBA-005`, `NBA-007`, `NBA-012`, `NBA-013` 보안/운영 계약 정리
2. `NBA-003`의 Company/Contact/Product latest summary 잔여 범위, `NBA-004` product feature 설계
3. `NBA-011` MeetingNote provider audit 설계
