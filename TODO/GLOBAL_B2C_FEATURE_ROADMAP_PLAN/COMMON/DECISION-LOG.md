...
| 01~11 pre-12 후속 재대조와 post-12 최종 재검토 | 2026-08-09 기준 12 착수 전 01~11 완료 슬롯 재대조와 BEFORE_12 closeout은 완료됐다. 선택된 `PRE12-F04`, `PRE12-F31`, `PRE12-F32`, `PRE12-F33`, `PRE12-F34`만 12 전에 닫았고, billing/paywall/churn/paid conversion/invoice/tax에 직접 연결되는 항목은 12 전 임시 구현으로 처리하지 않고 12 또는 post-12 seed로 보류한다. 12 완료 후에는 01~12 전체와 입력 계획 2개, 실제 BE/FE/Prisma 상태를 다시 학습해 최종 후속 TODO로 재배치한다. |
