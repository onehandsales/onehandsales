...
- [ ] `04_GOOGLE_CALENDAR_INTEGRATION`: Goal Ready (2026-07-22), DB migration 예정
...
| 리텐션/일정 루프 | 02~05 | 02 알림과 03 주간 일정 보고서는 완료. 04 Google Calendar는 구현 착수 가능한 계약까지 확정했고, AI 리포트로 반복 사용 이유를 이어 만든다. |
...
4. `04_GOOGLE_CALENDAR_INTEGRATION` - Goal Ready
