...
| G03 | users summary/activity API | 없음 | users list/detail | 없음 | ADMIN_USER_OPERATION_API |
...
| G07 | analytics overview API | 없음 | analytics overview | 없음 | ADMIN_ANALYTICS_API |
