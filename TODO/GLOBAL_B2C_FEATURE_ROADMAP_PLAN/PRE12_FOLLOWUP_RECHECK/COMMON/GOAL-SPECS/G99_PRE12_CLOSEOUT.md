...
- [x] G02~G04 후보가 post-12 보류 대상으로 분류 완료
...
- 12 착수 전 남은 보류 목록 확정
- `COMMON/FINAL-CLASSIFICATION.md`의 12 전에 닫힌 것 5개 중 실제 closeout 대상 반영
...
- [x] 12 전 처리한 항목과 12 이후로 보류한 항목이 표로 남는다.
- [x] `PRE12-F04`, `PRE12-F31`, `PRE12-F32`, `PRE12-F33`, `PRE12-F34` 외에는 12 전 작업으로 남기지 않는다.
- [x] 12 착수 전 구현 금지 항목이 명확히 남는다.
