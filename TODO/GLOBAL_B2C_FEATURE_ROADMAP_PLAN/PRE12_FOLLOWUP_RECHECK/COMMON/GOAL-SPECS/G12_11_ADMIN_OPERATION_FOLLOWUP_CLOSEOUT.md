...
| ImportJob Admin 전용 화면/API와 cleanup failure aggregate/system gate | `PRE12-F13` | 01/11 미완성이 아니다. 01 cleanup은 safe summary log 범위이고 11 system gate는 generic operation check 기록이다. import scale/source/Admin ops 전략에서 post-12 재검토한다. |
