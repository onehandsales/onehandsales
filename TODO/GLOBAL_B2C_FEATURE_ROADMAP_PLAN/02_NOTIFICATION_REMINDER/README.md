...
- Backend에는 Notification module/API/DB가 없다.
- `BE/prisma/schema.prisma`에는 `UserNotificationSetting`, `Notification`, `BrowserPushSubscription`, `NotificationDeliveryAttempt`가 없다.
