...
| 원본 항목 | 10 반영 | 위치 |
|---|---|---|
| `NBA-005` BusinessCard provider failure code/message contract | 완료. safe failure code/message/retryable 계약과 DB safe field migration을 구현 | `COMMON/API-SPEC/BUSINESS_CARD_MOBILE_CAPTURE_AND_FAILURE_CONTRACT.md`, `COMMON/GOAL-SPECS/G02_BUSINESS_CARD_MOBILE_CAPTURE_AND_FAILURE.md` |
| Product Analytics 09 후속: 모바일/PWA field-use 세부 event | 완료. 10에서 최소 품질 event로 반영 | `COMMON/EVENT-TAXONOMY.md`, `COMMON/GOAL-SPECS/G06_MOBILE_FIELD_ANALYTICS_EVENTS.md` |
