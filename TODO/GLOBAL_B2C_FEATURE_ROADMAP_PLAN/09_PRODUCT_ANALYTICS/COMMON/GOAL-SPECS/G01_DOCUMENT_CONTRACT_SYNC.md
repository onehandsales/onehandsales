...
- `BE-TODO/DB-SCHEMA.md`에 `ProductAnalyticsEvent.eventName` runtime allowlist와 12 Billing reserved event name 동기화 기준을 추가했다.
...
- 11 Admin과 12 Billing 문서를 확인했고, Admin analytics UI/API와 billing/paywall/churn 최종 흐름은 09 구현 범위와 섞이지 않는다.
