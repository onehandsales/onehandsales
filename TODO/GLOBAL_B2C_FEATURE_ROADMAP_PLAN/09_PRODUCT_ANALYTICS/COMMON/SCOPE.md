...
| Event | Owner |
|---|---|
| `paywall_viewed`, `upgrade_clicked`, `trial_started`, `coupon_applied`, `referral_invited`, `subscription_started`, `subscription_canceled`, `churn_survey_submitted` | 12 Billing에서 최종 확정 |
