...
7. MeetingNote 자동 발송/알림, PWA/native packaging, Google Calendar write/webhook/recurrence, generic ExportJob은 후속 재검토에서 first-sale follow-up인지 Series A later인지 다시 분류한다.
