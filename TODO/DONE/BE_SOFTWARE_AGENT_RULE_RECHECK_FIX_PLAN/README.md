...
후속으로 분리된 활성 계획은 `TODO\API_SPEC_TEMPLATE_NORMALIZATION_PLAN`이다. 2026-08-30 기준 `TODO\DONE\PRESENTATION_CONTRACT_TYPE_BOUNDARY_PLAN`은 G01/G02/G99를 완료해 완료 보관했다.
