...
기존 단일 문서 `TODO/DONE/BE_SOFTWARE_AGENT_RULE_RECHECK_FIX_PLAN.md`의 내용을 `TODO/PADDLE_PLAN`처럼 `COMMON`, `BE-TODO`, `FE-TODO` 단위로 분리했고, G99 최종 검토 완료 후 폴더형 정본은 `TODO/DONE/BE_SOFTWARE_AGENT_RULE_RECHECK_FIX_PLAN`에 보관했다.
...
| G07 | Completed | `TODO_LOG\2026-08-29\BE_SOFTWARE_AGENT_RULE_RECHECK\G07_API_SPEC_TEMPLATE_AUDIT\WORK_LOG.md`, `TODO\DONE\API_SPEC_TEMPLATE_NORMALIZATION_PLAN` |
| G08 | Completed | `TODO_LOG\2026-08-29\BE_SOFTWARE_AGENT_RULE_RECHECK\G08_PRESENTATION_REPOSITORY_PROJECTION_AUDIT\WORK_LOG.md`, `TODO\DONE\PRESENTATION_CONTRACT_TYPE_BOUNDARY_PLAN` |
...
후속으로 분리된 `TODO\DONE\API_SPEC_TEMPLATE_NORMALIZATION_PLAN`은 2026-08-31 기준 G01~G06과 G99를 완료해 완료 보관했다. 2026-08-30 기준 `TODO\DONE\PRESENTATION_CONTRACT_TYPE_BOUNDARY_PLAN`은 G01/G02/G99를 완료해 완료 보관했다.
