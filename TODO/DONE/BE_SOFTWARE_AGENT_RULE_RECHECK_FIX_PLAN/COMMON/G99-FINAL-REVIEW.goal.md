...
- `TODO/DONE/API_SPEC_TEMPLATE_NORMALIZATION_PLAN`과 `TODO/DONE/PRESENTATION_CONTRACT_TYPE_BOUNDARY_PLAN`의 완료 보관 상태가 상위 TODO 문서와 일치한다.
...
- 2026-08-31 기준 후속 `TODO\DONE\API_SPEC_TEMPLATE_NORMALIZATION_PLAN`도 G01~G06 및 G99를 완료해 완료 보관됐다.
