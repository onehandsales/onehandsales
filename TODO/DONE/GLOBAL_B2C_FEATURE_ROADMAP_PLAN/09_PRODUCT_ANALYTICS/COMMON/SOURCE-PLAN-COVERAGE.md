...
| AI cost/user 확인 필요 | 09에서는 기존 `AiProviderCallLog` 기반 summary를 사용하고 quota/plan source of truth는 `TODO/PADDLE_PLAN`으로 이관 |
...
| Paddle Billing Plan | paywall/trial/coupon/referral/churn/payment event 최종 계약 위치 |
