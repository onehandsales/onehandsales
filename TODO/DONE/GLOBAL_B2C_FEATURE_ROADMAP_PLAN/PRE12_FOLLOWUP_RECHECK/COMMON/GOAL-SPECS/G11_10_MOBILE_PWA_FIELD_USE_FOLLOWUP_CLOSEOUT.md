...
| PWA/native packaging과 install attribution | `PRE12-F30` | 후속 seed / 별도 mobile roadmap | 10을 재오픈하지 않는다. PWA/offline/full offline sync/native bridge/native attribution 계약은 후속 또는 별도 mobile roadmap에서 만든다. |
