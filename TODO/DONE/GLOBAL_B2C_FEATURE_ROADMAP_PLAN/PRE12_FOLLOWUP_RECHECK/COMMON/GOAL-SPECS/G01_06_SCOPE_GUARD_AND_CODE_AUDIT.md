...
최종 기준은 `../FINAL-CLASSIFICATION.md`다. 06 관련 남은 후보는 `PRE12-F01`, `PRE12-F02`, `PRE12-F03`, `PRE12-F07`, `PRE12-F08`, `PRE12-F38`, `PRE12-F39`, `PRE12-F40` 등으로 분리됐고, PRE12 구현 대상으로 올리지 않는다.
