...
- 로드맵 DONE 이후 필요성이 확인될 때 새 TODO 또는 별도 유지보수 계획에서 다시 판단한다.
- 판단 시 `NEXT_BACKEND_API_BACKLOG_PLAN`, `USER_WEB_PRODUCTIZATION_GAP_PLAN`, 01~11 완료 문서, `TODO/PADDLE_PLAN`, 실제 BE/FE/Prisma 상태를 함께 대조한다.
