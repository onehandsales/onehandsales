...
- `G00-PENDING-QUESTIONS.md`: G00의 새 미확정 질문과 확정된 질문 처리 이력을 기록한다. 현재 구현 정본은 `G00-DECISIONS.md`다.
...
- G00 결정이 남아 있으면 `G00-PENDING-QUESTIONS.md`의 새 미확정 질문을 한 번에 하나씩 확정한 뒤 관련 문서와 `G00-DECISIONS.md`에 반영한다.
