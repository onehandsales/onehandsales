...
G09 담당자 화면과 딜 생성의 담당자 선택 UI가 사용할 API를 제공한다.
...
- 회사 검색 결과가 없으면 최소 회사 생성을 먼저 제공하고, 회사 없이 담당자 저장은 허용하지 않는다.

### 완료 기준

- 담당자 생성, 목록, 상세, 수정, 삭제가 가능하다.
- 회사 연결 UI가 동작한다.
