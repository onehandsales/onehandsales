...
구현 시 API별 request 필드, 비즈니스 로직 흐름, response 필드, 연결 DB, transaction, 에러 기준은 `TODO/DONE/MVP-STARTER_PLAN/COMMON/API-SPEC/G06-G12-ENDPOINT-CONTRACT.md`를 상세 계약 정본으로 본다.
