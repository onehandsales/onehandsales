...
- 2026-07-18 UX reference 갱신: G01 완료 후 `Notion식 작업 공간 UX + Attio식 CRM record 관계 UX`가 전역 기준으로 고정됐다. G01의 screenshot baseline은 유지하되, G02~G06은 `020_uxui_notion_attio_reference.md`를 추가 기준으로 적용한다.
