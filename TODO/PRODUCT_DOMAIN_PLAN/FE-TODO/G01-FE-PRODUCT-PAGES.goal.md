...
rg -n "unitPrice|currency|description|initialMemo|ProductConnection|ProductLog|permanentDeleteAt|DELETE /api/products|restore|includeDeleted" FE/user-web/src TODO/PRODUCT_DOMAIN_PLAN
git diff --check
```
