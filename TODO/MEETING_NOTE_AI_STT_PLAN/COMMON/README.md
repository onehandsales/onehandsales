...
이 폴더는 회의록 직접 작성 저장과 AI/STT 초안 생성 작업에서 Frontend와 Backend가 함께 봐야 하는 사용자 흐름, API 계약, goal 순서, 구현 전 검토 결과를 관리한다.

## 2. 문서 구성

- `USER-FLOW.md`: 사용자가 회의록을 직접 저장하거나 AI/STT 초안으로 정리한 뒤 저장하는 흐름
