...
| Notification | Backend 없음 | domain, delivery channel, settings, rate limit | 첫 판매 retention 필요성 결정 전 구현 금지 |
...
5. ImportJob, Notification, Admin, Payment는 각각 별도 계획으로 분리한다.
