...
| BusinessCard | OCR scan log, upload scan, KR/US phone normalization, confirm company/contact |
...
| Global Data I18N | 구현 완료 | User country/locale/default currency, app i18n API 기반 설정, Product/Deal currency, Contact KR/US phone, Company country/region/address, import/export localization, Google/LINE/Apple auth 구현 완료. 현재 `BE/.env` 연결 DB는 2026-07-29 최신 상태 재확인 완료, LINE/Apple 실제 provider smoke는 운영 확인 필요 | 완료 |
