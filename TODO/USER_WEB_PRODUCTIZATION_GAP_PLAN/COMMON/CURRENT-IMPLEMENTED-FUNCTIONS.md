...
상태: Draft Guide
기준: 2026-07-28 현재 코드와 AGENT 구현 상태 문서
...
|---|---|---|---|---|
| Auth/User | `/api/auth/providers`, Google/LINE/Apple exchange, verified email linking, refresh, logout, `/api/me`, profile, country/locale/default currency, devices | Google/LINE/Apple OAuth login/signup, protected route, settings/profile/global preferences/devices | `/admin/api/me` 기반 보호 route | User Web 완료, Admin auth만 부분 완료. 실제 provider smoke는 운영 설정 후 확인 |
