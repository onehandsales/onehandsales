...
| 회의록 | 직접 작성, AI/STT, 딜 활동 연결, 후속 행동 추출이 된다. | 직접/AI/STT draft와 딜 연결 구현. 회의록 연결/해제는 딜 activity timeline에 안전한 summary로 연결 | next/latest summary, provider log, transcript 정책 없음 | Feature/Ops gap | 후속 |
