...
- [ ] `01_IMPORT_JOB_PERSISTENCE` G05~G08 최종형 보관/삭제/입력량 제한 보강 구현 및 QA. 완료 시 ImportJob 범위는 최종 서비스 형태 기준 완전 종료
...
| Import | 업로드 중단/새로고침/배포에도 이어받고, 원본/row snapshot 보관 기간과 입력량 제한이 Global B2C 신뢰 기준과 맞는다. | ImportJob DB persistence/resume G01~G04 구현 완료. G05~G08 최종형 보강은 `01_IMPORT_JOB_PERSISTENCE`에서 구현 대기 | terminal cleanup, 원본 file binary 즉시 삭제, `ImportUserLogRow` 30일 cleanup, 10MB/5,000행 제한까지 끝나면 01은 최종 서비스 형태 기준 완전 종료 | Closed for NBA-006 G01~G04 / Final hardening pending | G05~G08 완료 후 완전 종료 |
