...
| G06 | Completed | 커밋 예정, `TODO_LOG\2026-08-28\BE_SOFTWARE_AGENT_RULE_RECHECK\G06_BOOTSTRAP_PROCESS_ENV_POLICY\WORK_LOG.md` |
| G07 | Next | `COMMON\G07-API-SPEC-TEMPLATE-AUDIT.goal.md` |
...
G01, G02, G03, G04, G05, G06은 완료되었으므로 다음 실행은 G07부터 시작한다.
