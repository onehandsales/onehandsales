...
- `G01`은 완료되었고, 다음 실행 대상은 `G02`다.
- `G02`는 남은 P1이므로 먼저 처리한다.
...
| 2 | G02 | `BE-TODO/G02-SALES-REPORT-SCHEDULE-REPOSITORY-BOUNDARY.goal.md` | 코드 수정 | Next |
| 3 | G03 | `BE-TODO/G03-AI-WEEKLY-REPORT-OBSERVABILITY.goal.md` | 코드/테스트 수정 | Ready |
