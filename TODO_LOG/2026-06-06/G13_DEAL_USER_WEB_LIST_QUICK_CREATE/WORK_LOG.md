...
- 단계 탭, 검색, 필터 구현
- 딜 row/card 표시 순서: 딜명 -> 회사/담당자 -> 단계 -> 금액 -> 가능성 -> 다음 행동 -> 마감일
- 딜 빠른 등록 modal 구현
- 회사/거래처/제품 검색 combobox 구현
...
- 2026-06-06: 딜 빠른 등록 modal 구현
  - 필수 입력: 딜명, 금액
  - 선택 입력: 회사, 거래처, 제품, 단계, 가능성, 다음 행동, 다음 행동 일시, 예상 종료일, 첫 메모
...
- 통과: G13 Playwright smoke
  ...
  - 회사/거래처/제품 combobox 검색 선택 확인
  - 생성 후 목록 row 표시 확인
  - 리스트 헤더 순서 확인: `딜명`, `회사/담당자`, `단계`, `금액`, `가능성`, `다음 행동`, `마감일`
