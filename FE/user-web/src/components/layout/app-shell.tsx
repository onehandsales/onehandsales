    ...
    <div className="min-h-dvh bg-background text-foreground" data-app-i18n-root>
      ...
      >
        ...
        >
          ...
          {/* Nav */}
          <div className="notion-scrollbar min-h-0 flex-1 overflow-x-hidden overflow-y-auto px-2 py-1 [scrollbar-gutter:stable]">
            <SidebarNav
