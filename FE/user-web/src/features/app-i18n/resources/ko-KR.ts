...
export const koKRResource = {
  ...
  navigation: {
    ...
    appNameOpen: "기타 열기",
    home: "홈",
    quickWorkGroup: "빠른 업무",
    quickWorkGroupAdd: "빠른 업무 추가",
    quickWorkGroupClose: "빠른 업무 닫기",
    quickWorkGroupOpen: "빠른 업무 열기",
    mainGroup: "관리 항목",
    mainGroupAdd: "관리 항목 추가",
    mainGroupClose: "관리 항목 닫기",
    mainGroupOpen: "관리 항목 열기",
    workListsGroup: "업무 목록",
    workListsGroupAdd: "업무 목록 추가",
    workListsGroupClose: "업무 목록 닫기",
    workListsGroupOpen: "업무 목록 열기",
    more: "더보기",
    settings: "설정",
  },
  shell: {
