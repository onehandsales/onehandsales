...
export const enResource = {
  ...
  navigation: {
    ...
    home: "Home",
    quickWorkGroup: "Quick Work",
    quickWorkGroupAdd: "Add quick work",
    quickWorkGroupClose: "Close quick work",
    quickWorkGroupOpen: "Open quick work",
    mainGroup: "Items",
    mainGroupAdd: "Add item",
    mainGroupClose: "Close items",
    mainGroupOpen: "Open items",
    workListsGroup: "Work Lists",
    workListsGroupAdd: "Add work list",
    workListsGroupClose: "Close work lists",
    workListsGroupOpen: "Open work lists",
    more: "More",
    settings: "Settings",
  },
  shell: {
