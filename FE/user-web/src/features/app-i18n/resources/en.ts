...
export const enResource = {
  ...
  helpModal: {
    ...
    guideDescription:
      "Use these checkpoints to review deals and customer records in one workspace.",
    ...
    guideWorkDescription:
      "Keep deal activity and next actions visible in the customer flow.",
    guideWorkTitle: "Deal Activity",
  ...
  home: {
    ...
    dealsNextActions: "Deal Next Actions",
    ...
    emptyNextActions: "Next actions will appear here.",
    homeTitle: "Home",
