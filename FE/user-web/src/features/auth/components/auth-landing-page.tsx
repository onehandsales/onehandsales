...
> = {
  ...
  "zh-TW": {
    assistants: {
      ...
      title: "隨時可詢問的銷售助理。",
      description:
        "搜尋、會議紀錄、安全問答與跟進任務，都可以在同一個工作區中請求與處理。",
      ...
      cards: [
        ...
        },
        {
          eyebrow: "統一搜尋",
          title: "一次找到完整客戶脈絡。",
          description: "連結文件、筆記、行程與 CRM 紀錄，立即顯示所需依據。",
          items: ["統一搜尋", "附來源回答", "重複使用團隊知識"],
        },
        {
          eyebrow: "會議紀錄",
          title: "會議結束後自動完成紀錄。",
          description: "自動整理討論、決策與下一步行動，並寫入交易頁面。",
          items: ["核心摘要", "行動項目", "依與會者跟進"],
        },
        {
          eyebrow: "營收回顧",
          title: "立即查看本週推進的交易。",
          description: "團隊用同一標準查看進度、回覆延遲與營收預測變化。",
          items: ["每週營收摘要", "瓶頸帳戶", "管理者報告"],
        },
      ],
    },
    together: {
      ...
      cards: [
        {
          eyebrow: "文件",
          title: "輕鬆管理提案與客戶資料。",
          description: "把銷售資料連結到交易，在需要時快速找到。",
          items: ["提案", "檢查清單", "審核紀錄"],
        },
        {
          eyebrow: "知識庫",
          title: "團隊和代理使用同一份知識。",
          description: "把常見問題與內部政策整理成可回答的知識。",
          items: ["安全回答", "產品說明", "價格政策"],
        },
        {
          eyebrow: "上線追蹤",
          title: "不錯過上線與客戶啟用進度。",
          description: "在同一看板中查看客戶啟用、合約與訓練行程。",
          items: ["客戶啟用", "訓練行程", "完成標準"],
        },
      ],
    },
    trust: {
      ...
      testimonials: [
        {
          company: "Cursor-style sales team",
          quote: "團隊基於同一份交易脈絡行動，跟進速度明顯提升。",
          person: "Revenue Lead",
          tone: "bg-[#e95a48]",
        },
        {
          company: "Pipeline operations",
          quote: "會議紀錄、搜尋與任務分派在同一個畫面，每週回顧更輕鬆。",
          person: "Sales Ops",
          tone: "bg-[#1f79b8]",
        },
        {
          company: "Growth team",
          quote: "小型團隊也能像企業團隊一樣管理客戶歷史。",
          person: "Founder",
          tone: "bg-[#d89c25]",
        },
      ],
      stats: ["整合客戶紀錄", "自動化重複任務", "支援多語團隊", "適合行動裝置"],
    },
  },
  "en-US": {
    assistants: {
...
const landingCopyByLanguage: Record<PublicSiteCopyLanguage, LandingCopy> = {
  ...
  "zh-TW": {
    ...
    work: {
      ...
      title: "讓銷售 24 小時持續推進。",
      description:
        "無論諮詢進入或會議結束，代理都會讀取紀錄並建立下一步任務。",
      tabs: [
        {
          title: "Q&A 代理",
          description: "從銷售資料與客戶歷史中快速找到答案。",
        },
        {
          title: "任務路由",
          description: "自動整理負責人、截止日期與優先順序。",
        },
        {
          title: "提醒代理",
          description: "把容易遺漏的跟進任務送到團隊頻道。",
        },
        {
          title: "安全審核",
          description: "分開管理敏感資訊與審核流程。",
        },
        {
          title: "自訂建立",
          description: "把團隊的重複流程設定成代理。",
        },
      ],
      previewTitle: "商機工作台助理",
      previewBoardTitle: "銷售問答",
    ...
    workspace: {
      ...
      views: [
        {
          title: "客戶紀錄",
          description: "集中公司、聯絡人與對話歷史。",
        },
        {
          title: "交易進度",
          description: "快速查看每個階段的狀態與風險。",
        },
        {
          title: "會議筆記",
          description: "自動整理討論內容與下一步行動。",
        },
      ],
      tableHeaders: ["帳戶", "狀態", "下一步"],
      rows: [
        ["Acme Taiwan", "進行中", "價格審核"],
        ["Blue Retail", "跟進", "Demo 行程"],
        ["North Labs", "成交", "客戶啟用"],
      ],
      ...
      detailItems: [
        {
          title: "最近對話",
          description: "客戶在預算核准前要求安全檢查清單。",
        },
        {
          title: "建議行動",
          description: "寄送法務審核資料與下週會議時間。",
        },
      ],
    },
    final: {
