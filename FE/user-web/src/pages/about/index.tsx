    ...
    storyBlocks: [
      {
        title: "銷售工作曾經存在於對話之中。",
        description:
          "客戶脈絡從電話、聊天、郵件與筆記開始快速流動，但很少以有序的方式保留下來。",
        detail: "團隊可以推進交易，卻仍然遺失下一次跟進背後的原因。",
      },
      {
        title: "後來每個工具都變成另一個搜尋入口。",
        description:
          "CRM、試算表、通話紀錄、提案、任務與內部知識庫各自保存著一部分事實。",
        detail: "工作被記錄了，但找到正確答案仍然仰賴記憶。",
      },
      {
        title: "AI 讓找回遺失脈絡變得更容易。",
        description:
