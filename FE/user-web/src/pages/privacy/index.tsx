...
const privacyCopyByLanguage: Record<PublicSiteCopyLanguage, PrivacyCopy> = {
  ...
  "zh-TW": {
    ...
    californiaRows: [
      ["識別資訊", "服務供應商、關係企業、法律接收方、廣告合作夥伴", "適用的廣告合作夥伴"],
      ["商業資訊", "服務供應商、關係企業、法律接收方", "不會為無關第三方優惠出售/共享"],
      ["網路活動", "服務供應商、分析供應商、廣告合作夥伴", "適用的廣告合作夥伴"],
      ["一般地理位置", "服務供應商與分析供應商", "適用的廣告合作夥伴"],
      ["職業資訊", "服務供應商、關係企業、法律接收方", "不出售/共享"],
      ["推斷資訊", "服務供應商、分析供應商、廣告合作夥伴", "適用的廣告合作夥伴"],
    ],
    sections: [
      {
        id: "information-we-collect",
        title: "1. 我們蒐集的資訊",
        paragraphs: [
          "我們會蒐集你提供的資訊、你使用網站或服務時產生的資訊，以及其他來源提供給我們的資訊。",
        ],
        subsections: [
          {
            title: "A. 你提供的資訊",
            bullets: [
              "帳戶建立資訊：姓名、電子郵件地址、角色、公司資訊、個人資料與工作區詳情。",
              "聯繫與支援資訊：電子郵件、電話號碼、支援訊息、附件以及你選擇提供的其他資訊。",
              "付款資訊：透過付款服務供應商處理的帳單與交易資訊。",
              "協作內容：你在表單、留言、訊息與共享工作區中提交的內容。",
            ],
          },
          {
            title: "B. 自動蒐集的資訊",
            bullets: [
              "裝置與使用資料：IP 位址、瀏覽器、作業系統、語言、時區、瀏覽頁面與點擊。",
              "Cookie 與類似技術：支援登入、安全、偏好、分析與行銷的 Cookie 與本機儲存。",
              "分析資訊：協助我們了解產品表現並改進服務的彙總或事件層級使用資訊。",
            ],
          },
          {
            title: "C. 來自其他來源的資訊",
            bullets: [
              "第三方登入或整合供應商可能根據你的設定提供資料、帳戶或連線資訊。",
              "如果你的組織設定或管理帳戶，我們可能收到組織、角色、成員資格或工作區資訊。",
            ],
          },
        ],
      },
      {
        ...
        bullets: [
          "建立、驗證與管理帳戶和工作區。",
          "提供客戶紀錄、筆記、任務、交易工作流程與 AI 輔助功能。",
          "處理訂閱、帳單、付款、客戶支援、安全諮詢與隱私權請求。",
          "寄送服務訊息、產品更新與管理通知。",
          "改進平台可靠性、安全性與功能，並防止詐欺與濫用。",
        ],
      },
      {
        id: "disclosing",
        title: "3. 揭露資訊",
        paragraphs: [
          "根據你的使用方式與選擇，我們可能向服務供應商、業務合作夥伴、關係企業、廣告與分析合作夥伴、其他工作區使用者、組織管理員、法律接收方或交易相關方揭露資訊。",
        ],
      },
      {
        id: "international-transfers",
      ...
      },
      {
        ...
        bullets: [
          "對於基於同意的處理，你可以隨時撤回同意。",
          "你可以透過行銷郵件中的退訂說明停止接收行銷訊息。",
          "你可以透過瀏覽器設定或可用工具管理 Cookie。",
          "在適用法律要求的情況下，我們會回應法律認可的偏好訊號。",
        ],
      },
      {
        id: "privacy-rights",
        title: "6. 你的隱私權利",
        paragraphs: [
          "根據你的所在地與適用法律，你可能擁有存取、更正、刪除、限制或反對處理、資料可攜帶、不受歧視、授權代理請求與申訴等權利。",
        ],
      },
      {
        id: "retention",
        title: "7. 資料保留",
        paragraphs: [
          "我們會在提供服務、履行法律義務、解決爭議、執行協議、維護安全、進行稽核與支援合法業務目的所需期間保留資訊。",
          "工作區內容可能根據工作區設定、客戶協議、備份實務與法律要求保留。",
        ],
      },
      {
        id: "security",
        title: "8. 資訊安全",
        paragraphs: [
          "我們採取措施保護資訊，包括與處理資訊性質相符的管理、技術與組織保護措施。",
          "沒有系統是完全安全的。在法律允許的範圍內，我們無法保證資訊永遠不會遭未授權存取、揭露、更改或銷毀。",
        ],
      },
      {
        id: "third-party-websites",
      ...
      },
      {
        ...
        title: "10. 兒童資訊",
        paragraphs: [
          "服務面向一般商業使用者，並非面向兒童。如果我們發現未經有效同意蒐集了兒童個人資訊，會按適用法律採取合理步驟刪除。",
        ],
      },
      {
        id: "supervisory-authority",
        title: "11. 監管機構",
        paragraphs: [
          "如果你位於歐洲經濟區或英國等司法轄區，並認為我們的資訊處理違反適用法律，你可能有權向資料保護監管機構投訴。",
        ],
      },
      {
        id: "california",
        title: "12. 加州居民的附加資訊",
        paragraphs: [
          "加州隱私法可能要求我們提供有關蒐集個人資訊類別、使用目的以及揭露、共享或出售對象的附加資訊。",
          "本節中個人資訊、出售、共享與敏感個人資訊等術語採用適用加州法律規定的含義。",
        ],
      },
      {
        id: "data-privacy-framework",
      ...
      },
      {
        ...
        title: "14. 隱私權政策變更",
        paragraphs: [
          "我們可能不時修訂本隱私權政策。如變更重大，我們會按適用法律提供通知。",
          "更新後的隱私權政策生效後繼續使用網站或服務，表示你確認更新後的政策。",
        ],
      },
    ],
  },
