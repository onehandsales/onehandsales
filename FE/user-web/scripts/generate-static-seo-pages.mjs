...
const routeSeo = {
  ...
  "/solutions": {
    ...
    keywords: {
      ko: ["OneHand Sales 솔루션", "개인 영업 CRM", "부동산 CRM", "보험 영업 CRM", "자동차 영업 고객관리", "B2B 현장 영업 CRM"],
      en: ["OneHand Sales solutions", "personal sales CRM", "real estate CRM", "insurance agent CRM", "auto sales CRM", "B2B field sales CRM"],
    },
    priority: "0.7",
    changefreq: "monthly",
    schemaType: "WebPage",
  ...
  "/solutions/personal": {
    title: { ko: "개인 영업 CRM | OneHand Sales", en: "Personal Sales CRM | OneHand Sales" },
    description: {
    ...
    keywords: {
      ko: ["개인 영업 CRM", "1인 영업 CRM", "개인 고객관리", "영업 후속 연락", "개인 딜 관리"],
      en: ["personal sales CRM", "solo sales CRM", "individual sales CRM", "personal customer management", "sales follow-up CRM"],
    },
    priority: "0.7",
    changefreq: "monthly",
    schemaType: "WebPage",
  ...
  "/solutions/real-estate": {
    title: { ko: "부동산 중개 CRM | OneHand Sales", en: "Real Estate CRM | OneHand Sales" },
    description: {
    ...
    keywords: {
      ko: ["부동산 CRM", "부동산 중개 CRM", "부동산 고객관리", "매물 문의 관리", "부동산 상담 관리"],
      en: ["real estate CRM", "real estate agent CRM", "real estate client management", "property inquiry tracking", "real estate follow-up"],
    },
    priority: "0.7",
    changefreq: "monthly",
    schemaType: "WebPage",
  ...
  "/solutions/insurance-auto": {
    title: { ko: "보험/자동차 영업 CRM | OneHand Sales", en: "Insurance and Auto Sales CRM | OneHand Sales" },
    description: {
    ...
    keywords: {
      ko: ["보험 영업 CRM", "자동차 영업 CRM", "자동차 영업 고객관리", "보험 설계사 고객관리", "견적 후속 연락"],
      en: ["insurance agent CRM", "auto sales CRM", "car sales CRM", "quote follow-up CRM", "renewal follow-up CRM"],
    },
    priority: "0.7",
    changefreq: "monthly",
    schemaType: "WebPage",
  ...
  "/solutions/b2b-field": {
    title: { ko: "B2B 현장 영업 CRM | OneHand Sales", en: "B2B Field Sales CRM | OneHand Sales" },
    description: {
    ...
    keywords: {
      ko: ["B2B 현장 영업 CRM", "B2B 영업 CRM", "거래처 관리", "담당자 관리", "미팅 기록 CRM"],
      en: ["B2B field sales CRM", "B2B sales CRM", "account management CRM", "meeting notes CRM", "field sales follow-up"],
    },
    priority: "0.7",
    changefreq: "monthly",
    schemaType: "WebPage",
  ...
  "/help": {
    ...
    description: {
      ko: "OneHand Sales에서 고객, 딜, 일정, 회의록, 명함 스캔, 엑셀 흐름을 시작하는 기본 사용 방법을 확인하세요.",
      en: "Learn the basic OneHand Sales workflow for customers, deals, schedules, meeting notes, business card scanning, and Excel.",
    },
    keywords: {
  ...
  "/faq": {
    ...
    keywords: {
      ko: ["OneHand Sales FAQ", "OneHand Sales 자주 묻는 질문", "CRM 엑셀 다운로드", "AI CRM 도움말"],
      en: ["OneHand Sales FAQ", "OneHand Sales questions", "sales CRM FAQ", "CRM Excel export", "AI CRM help"],
    },
    priority: "0.6",
    changefreq: "monthly",
    schemaType: "WebPage",
