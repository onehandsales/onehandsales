...
export class AdminUserController {
  ...
  listUsers(
    ...
    return this.adminUserService.listUsers(currentUser, query, {
  ...
  getUserOverview(
    ...
    return this.adminUserService.getUserOverview(currentUser, userId, {
      requestId: request.requestId,
    });
  }
  ...
  listActivityTimeline(
    ...
    return this.adminUserService.listActivityTimeline(
      currentUser,
      userId,
      query
    );
