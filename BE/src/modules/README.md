...
| `notification` | User notification APIs, settings, unread count, read state, and encrypted browser push subscription storage |
| `health` | Lightweight health endpoint |

Admin operation APIs beyond `GET /admin/api/me`, Notification delivery/User Web integration, and generic DealActivity remain future scope.
