...
export class UserSidebarWorkspacesController {
  ...
  constructor(
    ...
    private readonly getMyDefaultSidebarWorkspaceUseCase: GetMyDefaultSidebarWorkspaceUseCase,
  ...
  // API : 사용자, 사이드바 기본 Workspace 조회
  @Get("default")
  getMyDefaultSidebarWorkspace(@CurrentUser() currentUser: CurrentUserContext) {
    // 1. application 계층에 현재 사용자의 기본 사이드바 Workspace 조회를 위임한다.
    return this.getMyDefaultSidebarWorkspaceUseCase.execute(currentUser);
  }
