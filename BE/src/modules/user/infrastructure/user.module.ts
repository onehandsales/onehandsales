...
import { USER_QUERY } from "../application/ports/user-query.port";
...
import { PrismaUserQueryRepository } from "./persistence/prisma-user-query.repository";
...
@Module({
  ...
  providers: [
    ...
    {
      provide: USER_QUERY,
      // 기능 : Prisma 서비스로 사용자 공개 조회 구현체를 생성합니다.
      useFactory: (prismaService: PrismaService) =>
        new PrismaUserQueryRepository(prismaService),
      inject: [PrismaService],
    },
  ],
  exports: [USER_QUERY],
